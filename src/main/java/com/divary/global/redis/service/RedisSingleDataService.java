...
public interface RedisSingleDataService {
    ...
    void setSingleData(String key, Object value);                        // Redis 단일 데이터 값을 등록/수정합니다.

    void setSingleData(String key, Object value, Duration duration);     // Redis 단일 데이터 값을 등록/수정합니다.(duration 값이 존재하면 메모리 상 유효시간을 지정합니다.)

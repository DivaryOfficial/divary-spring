...
public enum ErrorCode {
    ...
    LOG_BASE_ALREADY_EXISTS(HttpStatus.BAD_REQUEST,"LOGBASE_002","해당 날짜에 이미 로그 베이스가 존재합니다"),
    ...
    CONCURRENT_REQUEST_ERROR(HttpStatus.CONFLICT, "MEMBER_004", "탈퇴 요청 처리 중 데이터 충돌이 발생했습니다"),
    //소셜 로그인 관련
